...
export const STATIC_KNOWLEDGE_BASE: PolkadotKnowledge = {
    ...
    },
    {
      ...
      tokenDetails: [
        { symbol: 'DOT', decimals: 10, isNative: false, note: 'Mirror asset from Relay Chain' },
        {
          ...
          decimals: 6,
          isNative: false,
          issuer: 'Governance-registered asset (not issued by Tether)',
          note: 'Canonical governance-registered asset. Asset Hub allows multiple user-created assets with identical symbols. Always verify the assetId matches 1984, not just the symbol.',
        },
        {
          symbol: 'USDC',
          assetId: 1337,
          decimals: 6,
          isNative: false,
          issuer: 'Governance-registered asset (not issued by Circle)',
          note: 'Canonical governance-registered asset. Asset Hub allows multiple user-created assets with identical symbols. Always verify the assetId matches 1337, not just the symbol.',
        },
      ],
      xcmSupported: true,
      xcmVersion: null, // XCM version negotiated dynamically via runtime
  ...
  safetyGuidelines: {
    assetVerification: {
      ...
      verifiedAssets: {
        USDT: { assetId: 1984, issuer: 'Governance-registered asset (not issued by Tether)' },
        USDC: { assetId: 1337, issuer: 'Governance-registered asset (not issued by Circle)' },
      },
    },
  },
};
